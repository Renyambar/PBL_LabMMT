...
<section class="bg-gradient-to-r from-black/100 via-blue-800 to-blue-600 text-white py-16">
    <div class="container mx-auto px-4">
        <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-8">
            ...
            <div class="w-full md:w-2/3 md:pl-8 text-center md:text-left" data-aos="fade-left">
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border" data-aos="fade-up" data-aos-delay="0">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border" data-aos="fade-up" data-aos-delay="100">
                <div class="text-[#0F3A75] text-5xl mb-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border" data-aos="fade-up" data-aos-delay="200">
                <div class="text-[#0F3A75] text-5xl mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <?php if (!empty($featured_projects)): ?>
                <?php foreach ($featured_projects as $index => $project): ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition" data-aos="zoom-in" data-aos-delay="<?= $index * 100 ?>">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <?php if (!empty($recent_articles)): ?>
                <?php foreach ($recent_articles as $index => $article): ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition" data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>">
