<?php $page_title = isset($partner) ? 'Edit Partner' : 'Add Partner'; require_once '../app/views/layouts/admin_header.php'; ?>
...
<div class="bg-white rounded-lg shadow-lg p-8 max-w-2xl">
    <h2 class="text-2xl font-bold mb-6"><?= isset($partner) ? 'Edit' : 'Add New' ?> Partner</h2>
    ...
    <form action="<?= isset($partner) ? BASE_URL . '/admin/partners/update/' . $partner['id'] : BASE_URL . '/admin/partners/store' ?>" 
        ...
        <div class="mb-6">
            <label class="block text-gray-700 font-semibold mb-2">
                <i class="fas fa-building mr-2"></i>Partner Name *
            </label>
        ...
        <div class="mb-6">
            <label class="block text-gray-700 font-semibold mb-2">
                <i class="fas fa-image mr-2"></i>Partner Logo
            </label>
            ...
            <input type="file" name="logo" accept="image/*"
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
            <p class="text-sm text-gray-500 mt-1">Max size: 2MB. Formats: JPG, PNG, SVG (transparent background recommended)</p>
        </div>
        ...
        <div class="flex justify-end gap-4 mt-8">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i><?= isset($partner) ? 'Update' : 'Add' ?> Partner
            </button>
        </div>
    </form>
</div>
